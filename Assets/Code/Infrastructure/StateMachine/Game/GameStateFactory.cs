...
namespace Code.Infrastructure.StateMachine.Game
{
    ...
    {
        public GameStateFactory(IObjectResolver container) : base(container)
        {
        }

        protected override Dictionary<Type, Func<IExitable>> BuildStatesRegister(IObjectResolver container)
        {
